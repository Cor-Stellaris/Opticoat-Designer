                  ...
                  {traceInfoList.map(trace => {
                    ...
                    return (
                      <button
                        ...
                        style={{ cursor: 'pointer' }}
                      >
                        <div className="w-4 h-4 rounded border flex-shrink-0" style={{ backgroundColor: trace.traceData.colorInfo.hex || trace.traceData.colorInfo.rgb, borderColor: selected ? '#6366f1' : '#d1d5db' }}></div>
